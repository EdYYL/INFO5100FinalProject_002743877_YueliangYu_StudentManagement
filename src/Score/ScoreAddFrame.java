...
public class ScoreAddFrame extends JFrame {
	...
	public void InC() {
		...
		if (jTextField2.getText().length() == 0) {
			jOptionPane1.showMessageDialog(this, "The student number cannot be empty！", "notice", JOptionPane.INFORMATION_MESSAGE, null);
			...
			jOptionPane1.showMessageDialog(this, "The grade cannnot be empty！", "notice", JOptionPane.INFORMATION_MESSAGE, null);
		} else {
			try {
				boolean name = false;
				...
				if (name) {
					jOptionPane1.showMessageDialog(this, "The course name already exists！", "notice", JOptionPane.INFORMATION_MESSAGE, null);
				} else {
