...
public class ClassManager extends JFrame {
	...
	Object[][] arrData = {};
	String[] arrField = { "Class Number", "Department Name", "Major Name", "Class Name" };
	...
	private void jbInit() throws Exception {
		...
		jRadioButton1.setText("By Department：");
		...
		jRadioButton2.setText("By Major：");
	...
	public void jButton4_actionPerformed(ActionEvent e) {
		getM();
		if (intRow == -1) {
			jOptionPane1.showMessageDialog(this, "please select the class！", "notice", JOptionPane.INFORMATION_MESSAGE, null);
		} else {
	...
	public void jcb() {
		...
		jComboBox3.addItem("select major");
		try {
