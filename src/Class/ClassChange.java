 ...
 * Description: class information change
...
public class ClassChange extends JFrame {
	...
	private void jbInit() throws Exception {
		...
		jLabel1.setText("Class Information Update");
	...
	public void jButton1_actionPerformed(ActionEvent e) {
		...
		if (this.jTextField1.getText().trim().length() == 0) {
			...
			zhuanYe();
			try {
				// One major cannot have two same classes
	...
	// show default values in the update page
	public void xianshi() {
		if (find == null)
			return;
		else {
