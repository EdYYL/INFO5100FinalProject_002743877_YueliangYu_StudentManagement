...
public class LoginFrame extends JFrame {
	...
	private void jbInit() throws Exception {
		...
		jLabel_welcomeTitle.setText("Welcome to the");
		jLabel_welcomeTitle.setBounds(new Rectangle(140, 19, 246, 30));
		jLabel_systemTitle.setFont(new java.awt.Font("Dialog", Font.BOLD, 25));
		jLabel_systemTitle.setToolTipText("");
		jLabel_systemTitle.setText("Student Management System");
		jLabel_systemTitle.setBounds(new Rectangle(60, 61, 400, 29));
		jLabel_userName.setFont(new java.awt.Font("Dialog", Font.PLAIN, 18));
		jLabel_userName.setText("Username:");
		jLabel_userName.setBounds(new Rectangle(95, 123, 100, 25));
		jLabel_pwd.setFont(new java.awt.Font("Dialog", Font.PLAIN, 18));
		jLabel_pwd.setText("Password:");
		jLabel_pwd.setBounds(new Rectangle(95, 172, 100, 21));
		...
		jLabel_welcomeTitle2.setText("Welcome");*/
	...
	public void jButton_Login_actionPerformed(ActionEvent e) {
		...
		if (jTextField_userName.getText().length() == 0) {
			jOptionPane_LoginFeedback.showMessageDialog(this, "User name cannot be empty！", "Notice",
			...
			try {
				...
				if (cheng) {
					jOptionPane_LoginFeedback.showMessageDialog(this, "Username or Password is wrong！", "Notice",
							jOptionPane_LoginFeedback.INFORMATION_MESSAGE);
				}
				rs.close();
			} catch (Exception ce) {
