...
public class DepartAddFrame extends JFrame {
	...
	private void jbInit() throws Exception {
		...
		setTitle("Input Department");
		jLabel1.setFont(new java.awt.Font("Dialog", Font.BOLD, 20));
		jLabel1.setText("Input Department");
	...
	public void jButton1_actionPerformed(ActionEvent e) {
		...
		if (jComboBox1.getSelectedIndex() == 0) {
			jOptionPane1.showMessageDialog(this, "Select the department£¡", "notice", JOptionPane.INFORMATION_MESSAGE, null);
		} else if (jComboBox2.getSelectedIndex() == 0) {
			jOptionPane1.showMessageDialog(this, "Select the major£¡", "notice", JOptionPane.INFORMATION_MESSAGE, null);
		} else {
			xueYuan();
			zhuanYe();
			try {
				...
				if (departExist && specExist) {
					jOptionPane1.showMessageDialog(this, "The department and major have already existed£¡", "notice", JOptionPane.INFORMATION_MESSAGE, null);
				} else if (!departExist && specExist) {
					jOptionPane1.showMessageDialog(this, "The majot already exists in other department£¡", "notice", JOptionPane.INFORMATION_MESSAGE, null);
				} else if (departExist && !specExist) {
